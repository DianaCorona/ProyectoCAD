    ...
    var divfiles='<div class="fileinputs" id="fileinputs">'+
                '<div id="divfile0">'+
                    ...
                    '<div class="content-left">'+
                        '<label id="addarch0" class="ink-button green" for="file0" style="font-size:0.8em;padding:0 0.5em;">Elegir Archivo...</label>'+
                    '</div>'+
                '</div>'+
            '</div>'+
            '<div id="listfiles">'+
            '</div>'+
            '<br/>'+
            '<div id="mensajes" class="ink-label error all-100 small-100"></div>'+             
            '<br/>';
    ...
    $('#contentfiles').on('change','input.arch',function(){  
        ...
        for (var i = 0; i < this.files.length; i++)
        {
            ...
            if(filesname.indexOf(name)!=-1){
                ...
                $('#listfiles').html($('#listfiles').html()+
                        "<div id='divfilename"+filesn+"' class='all-100'><div class='all-60 small-100' style='padding-left:5px;'>"+name+"</div>"+
                            "<div class='all-40 filestat content-right' id='divfilestat"+filesn+"'>"+
        ...
        if(condicion){ //si se agrego un elemento a la lista de archivos se crea un nuevo div y un nuevo input:file
            ...
            var item='<div id="divfile'+filesn+'">'+
                        ...
                        '<div class="content-left">'+
                            '<label id="addarch'+filesn+'" class="ink-button green" for="file'+filesn+'" style="font-size:0.8em;padding:0 0.5em;">Elegir Archivo...</label>'+
                        '</div>'+
                    '</div>';
